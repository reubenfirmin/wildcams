...
from data_types import DeepFauneResult, InferenceResult
        ...
        try:
            ...
            class Model(nn.Module):
                def __init__(self, device=None):
                    ...
                    txt_animalclasses_fr = ['bison', 'blaireau', 'bouquetin', 'castor', 'cerf', 'chamois', 'chat', 'chevre', 'chevreuil', 'chien', 'daim', 'ecureuil', 'elan', 'equide', 'genette', 'glouton', 'herisson', 'lagomorphe', 'loup', 'loutre', 'lynx', 'marmotte', 'micromammifere', 'mouflon', 'mouton', 'mustelide', 'oiseau', 'ours', 'ragondin', 'raton laveur', 'renard', 'renne', 'sanglier', 'vache']
                    
                    self.base_model = timm.create_model(BACKBONE, pretrained=False, num_classes=len(txt_animalclasses_fr),
            ...
            raise RuntimeError(f"❌ DeepFaune configured but dependencies missing: {e}. Install with: pip install torch torchvision requests") from e
    ...
    def classify_detailed(self, image_crop: np.ndarray) -> DeepFauneResult:
        ...
        try:
            ...
            with torch.no_grad():
                ...
                species_names = ['bison', 'badger', 'ibex', 'beaver', 'red deer', 'chamois', 'cat', 'goat', 'roe deer', 'dog', 'fallow deer', 'squirrel', 'moose', 'equid', 'genet', 'wolverine', 'hedgehog', 'lagomorph', 'wolf', 'otter', 'lynx', 'marmot', 'micromammal', 'mouflon', 'sheep', 'mustelid', 'bird', 'bear', 'nutria', 'raccoon', 'fox', 'reindeer', 'wild boar', 'cow']
                ...
                logger.info(f"🦌 DeepFaune raw probs shape: {probs.shape}, max_idx: {best_species_idx}, max_prob: {max_prob:.3f}")
                ...
                non_animal_confidence = 1.0 - max_prob
