...
# Import torch after cache setup (deliberate module ordering)
...
class ModelManager:
    ...
    def __init__(self, ensemble_models: list[str], cache_dir: Path | None = None):
        ...
        # Model storage
        self.yolo_detectors: dict[str, YOLO | None] = {}
        self.rtdetr_models: dict[str, object | None] = {}
        self.megadetector_variants: dict[str, object | None] = {}
    ...
    def _load_megadetector_models(self):
        ...
        megadetector_variants_in_ensemble = [
            model for model in self.ensemble_models if model.startswith("MDV6-") and "rtdetr" not in model.lower()
        ]
    ...
    def get_available_models(self) -> list[str]:
        ...
        for registry in (self.yolo_detectors, self.rtdetr_models, self.megadetector_variants):
