...
DEFAULT_ENSEMBLE_MODELS: Final[list[str]] = ["yolo12x", "yolo12m", "MDV6-yolov10-e", "rtdetr-l"]
...
RTDETR_VARIANTS: Final[list[str]] = ["rtdetr-l", "rtdetr-x"]
...
TRACKING_METHOD_ALIASES: Final[dict[str, str]] = {"bbox": "simple", "bbox_simple": "simple"}
...
VIDEO_EXTENSIONS: Final[set[str]] = {".mp4", ".MP4", ".mov", ".MOV", ".avi", ".AVI", ".mkv", ".MKV", ".wmv", ".WMV"}
...
PIPELINE_STEP_NAMES: Final[list[str]] = ["motion_detection", "camera_handling_filter", "fullframe_validation"]
...
FEATURE_EXTRACTION_MODELS: Final[list[str]] = ["resnet18", "resnet50", "efficientnet_b0"]

DEFAULT_FEATURE_MODEL: Final[str] = "resnet18"
EXPECTED_FEATURE_DIMENSIONS: Final[dict[str, int]] = {"resnet18": 512, "resnet50": 2048, "efficientnet_b0": 1280}
