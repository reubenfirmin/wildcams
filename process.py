...
def initialize_config_from_args(args):
...
def main():
    ...
    try:
        processor = WildlifeVideoProcessor(config)
        ...
        processor.process_all_videos(config, video_filter=video_filter)
